                      ...
                      <tr v-for="role in filtersearch" :key="role.id">
                        ...
                        <td>
                          <div style="display: inline;" v-for="per in hasPermissions" :key="per.id">
                            <div style="display: inline;" v-if="per.name == 'role-edit'">
                              <router-link :to="{name: 'edit-role', params:{id:role.id}}" class="btn btn-sm btn-primary">Edit</router-link>
                            </div>
                            <div style="display: inline;" v-if="per.name == 'role-delete'">
                              <a @click="deleteRole(role.id)" class="btn btn-sm btn-danger"><font color="#ffffff">Delete</font></a>
                            </div>
                          </div>
                        </td>
                      </tr>
