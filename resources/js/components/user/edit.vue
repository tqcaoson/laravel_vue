 ...
 <div class="row">
  <router-link to="/user" class="btn btn-primary">All User </router-link>
    ...
    <div class="row justify-content-center">
      ...
      <form class="user" @submit.prevent="userUpdate" enctype="multipart/form-data">
     ...
     <div class="col-md-6">
         <input type="email" class="form-control" id="exampleInputFirstName" disabled placeholder="Enter Your Email" v-model="form.email">
