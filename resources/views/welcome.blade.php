  ...
  <nav id="sidebar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget' ? false : true " style="display:  none;"> 
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
     ...
     <li class="nav-item bg-info">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrap0"
          aria-expanded="true" aria-controls="collapseBootstrap0">
          <i class="far fa-fw fa-window-maximize"></i>
          <span>Phân Quyền</span>
        </a>
        <div id="collapseBootstrap0" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
           
           <router-link class="collapse-item" to="/user">All User</router-link>
           <router-link class="collapse-item" to="/role">All Role</router-link>
           <router-link class="collapse-item" to="/permission">All Permission</router-link>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <span class="mr-2"><script type="application/javascript"> document.write(localStorage.getItem('user')); </script></span>
     <img class="img-profile rounded-circle" src="{{ asset('backend/img/boy.png')}}" style="max-width: 60px">
    <router-link to="/logout" class="ml-2 d-lg-inline text-white small">Logout
    </router-link>
              </a>
